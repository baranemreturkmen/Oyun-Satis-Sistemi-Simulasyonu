...
public class FreeGamerManager implements GamerManager{
	...
	//Bu class'ımın altında FreeGamerların ekleme silme güncelleme ve loglama gibi işlemlerini yapacağım.
	//FreeGamerlara özel metodlar eklenirse şayet bu class altından eklenecek.
